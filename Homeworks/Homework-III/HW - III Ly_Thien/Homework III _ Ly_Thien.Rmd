---
title: "XAI Case Studies 2022L - Homework 3"
...
# We consider only 2 variables to plot CP profile
plot(cp_pr, variables = c("distanceToGoal", "angleToGoal"))
```


## Conclusion
CP profile returns rational reasons for prediction. When we fixed values of other features, the closer distance to Goal is (close to 0), the higher probability players will goal. Which angle to goal, closer to 90 degree, higher probability player will score.
