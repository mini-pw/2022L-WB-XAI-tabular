**Problem**: We want to model to predict the probability of a shot being scored. We want to evaluate the performance of a player or a team by calculating the xG metric over these prediction values.
