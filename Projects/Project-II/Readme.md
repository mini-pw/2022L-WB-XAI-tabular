**Problem**: The dataset describes properties of the houses in California. We want to model the median house price for households within the block (measured in US dollars).
